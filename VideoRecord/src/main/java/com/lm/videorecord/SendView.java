...
public class SendView extends RelativeLayout {
    ...
    private void init(Context context){
        LayoutParams params = new LayoutParams(DisplayUtil.getWidthPixels(context),DisplayUtil.dp2px(context,180f));
    ...
    public void startAnim(){
        ...
        set.playTogether(
                ObjectAnimator.ofFloat(backLayout,"translationX",0,-270),
                ObjectAnimator.ofFloat(selectLayout,"translationX",0,270)
        );
    ...
    public void stopAnim(){
        AnimatorSet set = new AnimatorSet();
        set.playTogether(
                ObjectAnimator.ofFloat(backLayout,"translationX",-270,0),
                ObjectAnimator.ofFloat(selectLayout,"translationX",270,0)
        );
        set.setDuration(250).start();
        setVisibility(GONE);
    }
